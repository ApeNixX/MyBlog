...
public class FileUtil {
    ...
    public String uploadFile(File file, String subCatalog){
        ...
        String md5Key = AliYunOSSClientUtil.uploadObject2OSS(ossClient, file, AliyunOssConfigConstant.BACKET_NAME,
                AliyunOssConfigConstant.FOLDER + subCatalog + "/");
        String url = AliYunOSSClientUtil.getUrl(ossClient, md5Key);
        String picUrl = "https://" + AliyunOssConfigConstant.BACKET_NAME + "." + AliyunOssConfigConstant.ENDPOINT +
                "/" + AliyunOssConfigConstant.FOLDER + subCatalog + "/" + file.getName();
