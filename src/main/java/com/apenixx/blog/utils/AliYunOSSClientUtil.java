...
public class AliYunOSSClientUtil {
    ...
    //初始化属性
    static{
        ENDPOINT = AliyunOssConfigConstant.ENDPOINT;
        ACCESS_KEY_ID = AliyunOssConfigConstant.ACCESS_KEY_ID;
        ACCESS_KEY_SECRET = AliyunOssConfigConstant.ACCESS_KEY_SECRET;
        BACKET_NAME = AliyunOssConfigConstant.BACKET_NAME;
        FOLDER = AliyunOssConfigConstant.FOLDER;
    }
